module.exports = [
  ...
  { name: 'markers', type: String, alias: 'm', group: 'destination', needsEqualsSign:true, useQuotesAroundValue:true },
  ...
  { name: 'encoder-preset', type: String, group: 'video', needsEqualsSign:true },
  ...
  { name: 'encoder-profile', type: String, group: 'video', needsEqualsSign:true },
  { name: 'encoder-profile-list', type: String, group: 'video' },
  { name: 'encoder-level', type: String, group: 'video', needsEqualsSign:true },
  ...
  { name: 'deinterlace', type: String, alias: 'd', group: 'filters', needsEqualsSign:true },
  ...
  { name: 'rotate', type: Number, group: 'filters', needsEqualsSign:true },
