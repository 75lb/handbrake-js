module.exports = [
  ...
  { name: 'large-file', type: Boolean, alias: '4', group: 'destination' },
  ...
  { name: 'two-pass', type: Boolean, alias: '2', group: 'video' },
  ...
  { name: 'mixdown', type: String, alias: '6', group: 'audio' },
  ...
  { name: 'decomb', type: String, alias: '5', group: 'filters' },
  { name: 'detelecine', type: String, alias: '9', group: 'filters' },
  { name: 'denoise', type: String, alias: '8', group: 'filters' },
  { name: 'nlmeans', type: String, group: 'filters' },
  { name: 'nlmeans-tune', type: String, group: 'filters' },
  { name: 'deblock', type: String, alias: '7', group: 'filters' },
