...
@param options {Object | Array} - [Options](https://trac.handbrake.fr/wiki/CLIGuide#options) to pass directly to HandbrakeCLI
@returns {module:handbrake-js~Handbrake} A `Handbrake` instance
