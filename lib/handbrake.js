...
exports.run.config = new cm.Config()
    ...
    .group("source")
        ...
        .option("start-at", { type: "string", valid: /duration|frame|pts/, invalidMsg: "please specify the unit, e.g. --start-at duration:10 or --start-at frame:2000" })
        .option("stop-at", { type: "string", valid: /duration|frame|pts/, invalidMsg: "please specify the unit, e.g. --stop-at duration:100 or --stop-at frame:3000" })
    .group("destination")
