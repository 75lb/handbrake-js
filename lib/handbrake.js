...
@param {Function} [onComplete] If passed, `onComplete(err, stdout, stderr)` will be called on completion.

Passing an `onComplete` callback is more convenient for short duration tasks: 
@example
