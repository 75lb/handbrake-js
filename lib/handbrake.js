...
util.inherits(exports.HandbrakeOptions, nature.Thing);
...
HandbrakeProcess.prototype.run = function(options, onComplete){
    var self = this;
...
exports.run = function(options, onComplete){
    ...
    handbrakeProcess.run(options, onComplete);
