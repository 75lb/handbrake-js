...
function HandbrakeProcess(){
    ...
    this.outputLog = "";
    this.outputStream = new stream.Transform();
    this.outputStream._transform = function(chunk, encoding, done){
...
HandbrakeProcess.prototype.run = function(options){
    ...
    handle.stdout.pipe(this.outputStream);
    handle.stderr.pipe(this.outputStream);
