...
function HandbrakeOptions(){
    this.define("general", [
            ...
            { name: "input", type: "string", alias: "i", valueTest: function(input){
                return fs.existsSync(input);
            }},
            { name: "output", type: "string", alias: "o", valueTest: function(output){
                return fs.existsSync(path.dirname(output));
            }},
