...
# handbrake-js
Handbrake-js is [Handbrake](http://handbrake.fr) (v1.1.2) for [node.js](http://nodejs.org), funnily enough. It aspires to provide a lean and stable foundation for building video transcoding software in node.js.
